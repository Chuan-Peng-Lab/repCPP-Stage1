...
expName = 'GTDT_C3'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=root_dir + 'GTDT_C3_coder.py',
...
text = visual.TextStim(win=win, name='text',
    ...
    languageStyle='LTR',
    depth=0.0);
#bstart = parallel.ParallelPort(address='0x5FB8')   # diff
...
for thisBlock in block:
    ...
    while continueRoutine and routineTimer.getTime() < 1.0:
        ...
        #    bstart.status = STARTED
        #    win.callOnFlip(bstart.setData, int(9))   # dell
    ...
    _key_resp_6_allKeys = []
    # keep track of which components have finished
    questionComponents = [text_2, textbox, key_resp_6]
