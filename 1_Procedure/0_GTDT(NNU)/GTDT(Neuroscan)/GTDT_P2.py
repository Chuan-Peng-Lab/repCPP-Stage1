...
expName = 'GTDT_P2'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\happy_working\\repCPP\\Stage1\\GradualTargetDetectionTask\\GTDT(Neuroscan)\\GTDT_P2.py',
...
i3 = visual.ImageStim(
    win=win,
    name='i3', 
    image='D:/happy_working/repCPP/Stage1/GradualTargetDetectionTask/GTDT(Neuroscan)/instruction3P2.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.6, 1),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
trials = data.TrialHandler(nReps=1.0, method='fullRandom', 
    ...
    trialList=data.importConditions('D:/happy_working/repCPP/Stage1/GradualTargetDetectionTask/GTDT(Neuroscan)/c2p.xlsx'),
