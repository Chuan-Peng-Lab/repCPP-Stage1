...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\happy_working\\repCPP\\Stage1\\GradualTargetDetectionTask\\GTDT(Neuroscan)\\zbuilder\\GTDT2_lastrun.py',
...
i1 = visual.ImageStim(
    win=win,
    name='i1', 
    image='D:/Desktop/新建文件夹/instruction1.png', mask=None, anchor='center',
...
i3 = visual.ImageStim(
    win=win,
    name='i3', 
    image='instruction3C3.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.6, 1),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
blocks = data.TrialHandler(nReps=1.0, method='fullRandom', 
    ...
    trialList=data.importConditions('blist_c3.xlsx'),
