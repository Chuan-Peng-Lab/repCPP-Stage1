...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\happy_working\\repCPP\\Stage1\\GradualTargetDetectionTask\\GTDT(Neuroscan)\\zbuilder\\GTDT_P.py',
...
for thisPractise_back in practise_back:
    ...
    trials = data.TrialHandler(nReps=1.0, method='fullRandom', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('D:/happy_learning/cpp/psychopy/make_new/c1p.xlsx'),
