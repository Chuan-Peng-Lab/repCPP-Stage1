...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\happy_working\\repCPP\\Stage1\\GradualTargetDetectionTask\\GTDT(Neuroscan)\\zbuilder\\GTDT3_lastrun.py',
...
i2 = visual.ImageStim(
    win=win,
    name='i2', 
    image='D:/happy_working/repCPP/Stage1/GradualTargetDetectionTask/GTDT(Neuroscan)/instruction2.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.6, 1),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
i3 = visual.ImageStim(
    win=win,
    name='i3', 
    image='D:/happy_working/repCPP/Stage1/GradualTargetDetectionTask/GTDT(Neuroscan)/instruction3C3.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.6, 1),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
i4 = visual.ImageStim(
    win=win,
    name='i4', 
    image='D:/happy_working/repCPP/Stage1/GradualTargetDetectionTask/GTDT(Neuroscan)/instruction4.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.6, 1),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
i5 = visual.ImageStim(
    win=win,
    name='i5', 
    image='D:/happy_working/repCPP/Stage1/GradualTargetDetectionTask/GTDT(Neuroscan)/instruction5.png', mask=None, anchor='center',
    ori=0.0, pos=(0, 0), size=(1.6, 1),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
    texRes=128.0, interpolate=True, depth=0.0)
...
blocks = data.TrialHandler(nReps=1.0, method='fullRandom', 
    ...
    trialList=data.importConditions('D:/happy_working/repCPP/Stage1/GradualTargetDetectionTask/GTDT(Neuroscan)/blist_c3.xlsx'),
...
for thisBlock in blocks:
    ...
    for thisTrial in trials:
        ...
        # update component parameters for each repeat
        # keep track of which components have finished
        GTDTComponents = [bg, annular, cover, center]
